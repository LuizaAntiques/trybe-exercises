...
divUm.addEventListener('click', selectUm);
divDois.addEventListener('click', selectDois);
divTres.addEventListener('click', selectTres);
...
function redirecionar() {
  window.location.href = 'https://luizaantiques.github.io/';
}
